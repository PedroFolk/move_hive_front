...
import { ExcluirPost, ListarPostProprios, PostUsuarioAlheio } from "~/features/feed/api/feed";
import { MaterialCommunityIcons, Ionicons } from "@expo/vector-icons";
import PostModal from "~/features/feed/components/ModalPosts";
import { ListarDadosPerfil, UsuarioAlheio, UsuariosSeguidos, PararDeSeguirUsuario, SeguirUsuario } from "../api/user";
import UsuariosModal from "../components/ModalUsuarios";
